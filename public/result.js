...
/* harmony export */   "geoLocationBtn": () => (/* binding */ geoLocationBtn),
/* harmony export */   "humbPercent": () => (/* binding */ humbPercent),
/* harmony export */   "subDegree": () => (/* binding */ subDegree),
/* harmony export */   "weatherContent": () => (/* binding */ weatherContent),
/* harmony export */   "weatherImg": () => (/* binding */ weatherImg),
/* harmony export */   "weatherKind": () => (/* binding */ weatherKind),
/* harmony export */   "weatherTemp": () => (/* binding */ weatherTemp)
/* harmony export */ });
const arrowBack = document.getElementById("back-mode-button");
const weatherContent = document.getElementById("info-content");
const alerts = document.querySelectorAll(".alert");
const cityInput = document.querySelector("input");
const geoLocationBtn = document.querySelector("button");
const weatherImg = document.querySelector("img");
const weatherTemp = document.querySelector(".degree");
const weatherKind = document.querySelector(".weather-kind");
const cityName = document.querySelector("#city-name");
const subDegree = document.querySelector(".sub-tem-span");
const humbPercent = document.querySelector(".hum-precent"); //You have to call for its FirstElementChild
...
const requestApi = function (entry) {
  if (entry.cod != "404") {
    ...
    _elements__WEBPACK_IMPORTED_MODULE_0__.alerts[1].classList.remove("d-none");
  }
};
function switchMode() {
  if (_elements__WEBPACK_IMPORTED_MODULE_0__.arrowBack.classList.contains("d-none")) {
    _elements__WEBPACK_IMPORTED_MODULE_0__.arrowBack.classList.replace("d-none", "d-inline-block");
  }
  if (_elements__WEBPACK_IMPORTED_MODULE_0__.weatherContent.classList.contains("d-none")) {
    document.forms[0].classList.add("d-none");
    _elements__WEBPACK_IMPORTED_MODULE_0__.weatherContent.classList.replace("d-none", "d-flex");
  }
}
function extractWeatherData(data) {
  ...
  _elements__WEBPACK_IMPORTED_MODULE_0__.subDegree.innerHTML = Math.floor(dataObject.tempture.tempLike);
  _elements__WEBPACK_IMPORTED_MODULE_0__.humbPercent.innerHTML = dataObject.tempture.tempHumidity + "%";
}

const weatherONLocation = function () {
...
function OnFaild(entry) {
  reHideAllAlerts();
  _elements__WEBPACK_IMPORTED_MODULE_0__.alerts[0].innerHTML = entry.message;
  _elements__WEBPACK_IMPORTED_MODULE_0__.alerts[0].classList.remove("d-none");
}

function reHideAllAlerts() {
  _elements__WEBPACK_IMPORTED_MODULE_0__.alerts.forEach(function (item) {
...
/* harmony import */ var _node_modules_bootstrap_dist_js_bootstrap_min_js__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_node_modules_bootstrap_dist_js_bootstrap_min_js__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _elements__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./elements */ "./scripts/elements.js");
/* harmony import */ var _functions__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./functions */ "./scripts/functions.js");
...
_elements__WEBPACK_IMPORTED_MODULE_3__.cityInput.addEventListener("keyup", function (e) {
  if (e.key == "Enter" && this.value) {
    ...
    weatherDetail
      .then((response) => response.json())
      .then((result) => (0,_functions__WEBPACK_IMPORTED_MODULE_4__.requestApi)(result));
  }
});
